...
(function () {
  ...
  // Base URL of the distribution machine. Empty string = same origin: the bot
  // is the one serving this site too, so all /api/* calls go to the same host
  // (jobcoin.tech). One domain, one server, no CORS, no subdomain.
  const MACHINE_API = "";
